...
diamond = Crystal.from_cif(r'C:\Users\krist\Documents\PYTHON PROJECTS ON VS CODE\NiF2_mp-559798_primitive.cif') 
#=======================================================================================================================================
...
print('The Bragg intensity is:',Bragg_intensity)
print('-------------------------------------------------------------------------------------------')
#Bragg_position = str(Bragg_position)
print('The Bragg positions are:',Bragg_position)
